...
public class BooksDataSet {
    ...
    public BooksDataSet() {
        books = new ArrayList<>(List.of(
                ...
                new Book("Ksiazka3", "Autor3", "Typ3", 300.0, "PLN", "300"),
                new Book("Ksiazka4", "Autor4", "Typ4", 400.0, "PLN", "400"),
                new Book("Ksiazka5", "Autor5", "Typ5", 500.0, "PLN", "500"),
                new Book("Ksiazka6", "Autor1", "Typ1", 600.0, "PLN", "600"),
                new Book("Ksiazka7", "Autor2", "Typ2", 700.0, "PLN", "700"),
                new Book("Ksiazka8", "Autor3", "Typ3", 800.0, "PLN", "800"),
                new Book("Ksiazka9", "Autor4", "Typ4", 900.0, "PLN", "900"),
                new Book("Ksiazka10", "Autor5", "Typ5", 1000.0, "PLN", "1000"),
